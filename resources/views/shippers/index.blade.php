            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="modal fade" id="shipperModal" tabindex="-1" aria-hidden="true" role="dialog"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="shipper_name">Shipper Name <span
                                                                    class="text-danger">*</span></label>
                                                            <div class="input-group">
                                                                <select class="form-select" id="shipper_prefix"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="shipper_name_input"
                                                                    placeholder="e.g. AJINOMOTO INDONESIA (AJI)"
                                                                    autocomplete="off" required />
                                                                <input type="hidden" name="shipper_name"
                                                                    id="shipper_name_final">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="shipper_address">Shipper
                                                                Address</label>
                                                            <input type="text" class="form-control" name="shipper_address"
                                                                id="shipper_address"
                                                                placeholder="e.g. Jl. Raya Mlirip No.110, Mlirip, Kec. Jetis, Kabupaten Mojokerto"
                                                                autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="shipper_concept">Shipper Concept
                                                                <span class="text-danger">*</span></label>
                                                            <select class="form-select" name="shipper_concept"
                                                                id="shipper_concept" required>
                                                                <option value="" disabled selected>Select Shipper Concept
                                                                </option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="shipper_type">Shipper Type <span
                                                                    class="text-danger">*</span></label>
                                                            <select class="form-select" name="shipper_type"
                                                                id="shipper_type" required>
                                                                <option value="" disabled selected>Select Shipper Type
                                                                </option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="shipper_city">Shipper City <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" name="shipper_city"
                                                                id="shipper_city" placeholder="e.g. MOJOKERTO"
                                                                autocomplete="off" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="contact_person">Contact
                                                                Person</label>
                                                            <input type="text" class="form-control" name="contact_person"
                                                                id="contact_person" placeholder="e.g. PAK YUDHA"
                                                                autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input type="text" class="form-control" name="phone_number"
                                                                id="phone_number" placeholder="e.g. +62 812-3456-7891"
                                                                autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input type="email" class="form-control" name="email_address"
                                                                id="email_address" placeholder="e.g. yudha@ajinomoto.co.id"
                                                                autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input type="text" class="form-control" name="export"
                                                                id="export" placeholder="e.g. THAILAND"
                                                                autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input type="text" class="form-control" name="import"
                                                                id="import" placeholder="e.g. SINGAPORE"
                                                                autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input type="text" class="form-control" name="domestic"
                                                                id="domestic" placeholder="e.g. KARAWANG"
                                                                autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="commodity">Commodity <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" name="commodity"
                                                                id="commodity" placeholder="e.g. RAW MATERIALS"
                                                                autocomplete="off" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <textarea class="form-control" name="notes" id="notes" rows="1"
                                                                placeholder="e.g. Add any specific handling or crane here..."></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <div class="modal fade" id="Viewshipper" tabindex="-1" aria-hidden="true" role="dialog"
                                data-bs-backdrop="static" data-bs-keyboard="false">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
                                    role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_shipper_address">Shipper
                                                            Address</label>
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_shipper_address" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_shipper_city">Shipper
                                                            City</label>
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_shipper_city" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_contact_person">Contact
                                                            Person</label>
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_contact_person" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_phone_number">Phone
                                                            Number</label>
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_phone_number" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_email_address">Email
                                                            Address</label>
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_email_address" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_export">Export</label>
                                                        <input type="text" class="form-control-plaintext" id="view_export"
                                                            readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input type="text" class="form-control-plaintext" id="view_import"
                                                            readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input type="text" class="form-control-plaintext" id="view_domestic"
                                                            readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <textarea class="form-control-plaintext" id="view_notes" rows="1"
                                                            readonly></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <tr id="row-{{ $shipper->id }}" data-user-id="{{ $shipper->user_id }}">
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <button type="button" class="btn btn-sm btn-info viewShipper"
                                                            data-id="{{ $shipper->id }}" data-bs-toggle="tooltip" title="View">
                                                        ...
                                                        <div class="btn-group btn-group-sm" role="group">
                                                            @if(Auth::user()->isSuperAdmin() || Auth::user()->isAdmin() || (Auth::user()->isMarketing() && $shipper->user_id == Auth::id()))
                                                                <button type="button" class="btn btn-sm btn-warning text-white editBtn"
                                                                    data-id="{{ $shipper->id }}" data-bs-toggle="tooltip" title="Edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-sm btn-danger deleteBtn"
                                                                    data-id="{{ $shipper->id }}" data-bs-toggle="tooltip"
                                                                    title="Delete">
