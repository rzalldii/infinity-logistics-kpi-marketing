                                                        ...
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <div class="position-relative">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    id="togglePassword"
                                                                    style="background: transparent; border: none; padding: 0; z-index: 10;">
                                                                    <i class="fas fa-eye" id="toggleIcon"></i>
                                                                </button>
                                                            </div>
                                                            <small class="text-muted" id="passwordHelp"
                                                                style="display:none;">Leave blank to keep current
                                                                password</small>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        ...
                                                        @if($user->id !== Auth::id())
                                                            @if(!$user->is_primary)
                                                                <button type="button" class="btn btn-sm btn-warning text-white editBtn"
                                                                    data-id="{{ $user->id }}" data-bs-toggle="tooltip" title="Edit">
