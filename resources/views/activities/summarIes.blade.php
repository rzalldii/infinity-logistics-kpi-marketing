@extends('layouts.app')
@section('title')
    Summary Activities | KPI - Marketing
@endsection
@section('content')
    <div class="container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="table-summary" class="display table table-striped table-hover table-bordered"
                                    style="width:100%">
                                                    ...
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        @if($isCurrentMonth)
                                                            <button type="button" class="btn btn-sm btn-warning text-white editBtn"
                                                                data-id="{{ $data['user_id'] }}" data-bs-toggle="tooltip"
                                                                title="Edit">
                            ...
                            <div class="modal fade" id="summaryModal" tabindex="-1" aria-hidden="true" role="dialog"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="target_activity">Target
                                                                Activity</label>
                                                            <input type="number" class="form-control" name="target_activity"
                                                                id="target_activity" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="target_volume">Target
                                                                Volume</label>
                                                            <input type="number" class="form-control" name="target_volume"
                                                                id="target_volume" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="target_profit">Target
                                                                Profit</label>
                                                            <input type="text" class="form-control"
                                                                name="target_profit_display" id="target_profit"
                                                                autocomplete="off" />
                                                            <input type="hidden" name="target_profit"
                                                                id="target_profit_real">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
