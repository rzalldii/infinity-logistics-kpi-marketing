                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="pol">Port Of Loading <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" name="pol" id="pol"
                                                                placeholder="e.g. SURABAYA" autocomplete="off" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="pod">Port Of Destination <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" name="pod" id="pod"
                                                                placeholder="e.g. PORT KLANG" autocomplete="off" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="container_type">Container Type
                                                                <span class="text-danger">*</span></label>
                                                            <select class="form-select" name="container_type"
                                                                id="container_type" required>
                                                                <option value="" disabled selected>Select Container Type
                                                                </option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="container_20">Container
                                                                20FT</label>
                                                            <input type="text" class="form-control"
                                                                name="container_20_display" id="container_20"
                                                                placeholder="e.g. 150" autocomplete="off">
                                                            <input type="hidden" name="container_20" id="container_20_real">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="container_40">Container
                                                                40FT</label>
                                                            <input type="text" class="form-control"
                                                                name="container_40_display" id="container_40"
                                                                placeholder="e.g. 250" autocomplete="off" />
                                                            <input type="hidden" name="container_40" id="container_40_real">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="liner">Liner / Forwarding <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" name="liner" id="liner"
                                                                placeholder="e.g. INFINITY" autocomplete="off" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input type="text" class="form-control" name="free_time"
                                                                id="free_time" placeholder="e.g. 14 Days + DET/DEM"
                                                                autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-default">
                                                            <label class="form-label" for="valid_date">Valid Date <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="date" class="form-control" name="valid_date"
                                                                id="valid_date" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <textarea class="form-control" name="notes" id="notes" rows="6"
                                                                placeholder="Add any specific conditions, incoterms, or internal remarks here..."></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <div class="modal fade" id="Viewrate" tabindex="-1" aria-hidden="true" role="dialog"
                                data-bs-backdrop="static" data-bs-keyboard="false">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
                                    role="document">
                                    <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input type="text" class="form-control-plaintext" id="view_pol"
                                                            readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input type="text" class="form-control-plaintext" id="view_pod"
                                                            readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_container_type">Container
                                                            Type</label>
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_container_type" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_container_20">Container
                                                            20FT</label>
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_container_20" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_container_40">Container
                                                            40FT</label>
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_container_40" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_liner">Liner /
                                                            Forwarding</label>
                                                        <input type="text" class="form-control-plaintext" id="view_liner"
                                                            readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input type="text" class="form-control-plaintext"
                                                            id="view_valid_date" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group form-group-default">
                                                        <label class="form-label" for="view_notes">Notes</label>
                                                        <textarea class="form-control-plaintext" id="view_notes" rows="5"
                                                            readonly></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <tr id="row-{{ $rate->id }}" data-user-id="{{ $rate->user_id }}">
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <button type="button" class="btn btn-sm btn-info viewRate"
                                                            data-id="{{ $rate->id }}" data-bs-toggle="tooltip" title="View">
                                                        ...
                                                        <div class="btn-group btn-group-sm" role="group">
                                                            @if(Auth::user()->isSuperAdmin() || Auth::user()->isAdmin() || (Auth::user()->isMarketing() && $rate->user_id == Auth::id()))
                                                                <button type="button" class="btn btn-sm btn-warning text-white editBtn"
                                                                    data-id="{{ $rate->id }}" data-bs-toggle="tooltip" title="Edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-sm btn-danger deleteBtn"
                                                                    data-id="{{ $rate->id }}" data-bs-toggle="tooltip" title="Delete">
